...
import { BookOpen, ArrowRight, LoaderCircle, Eye, EyeOff, Sparkles, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[440px]">
        ...
        {/* Auth Card */}
        <div className="bg-zinc-900/40 backdrop-blur-2xl border border-white/5 rounded-[2.5rem] p-8 md:p-10 shadow-2xl overflow-hidden relative group">
