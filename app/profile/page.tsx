...
const ProfilePage = () => {
    ...
    const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            toast.error("Connection disruption during upload", { id: toastId })
            setUploading(false)
        }
    }
    ...
    if (loading) return (
        <div className="h-screen flex flex-col items-center justify-center bg-[#020202] text-white">
            ...
            <p className="text-[10px] font-black uppercase tracking-[0.3em] animate-pulse">Synchronizing Neural Link...</p>
        </div>
    );
        ...
        <div className="min-h-screen bg-[#020202] text-zinc-100 p-4 md:p-8 font-sans selection:bg-emerald-500/30">
            <div className="max-w-4xl mx-auto space-y-12 py-10">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-zinc-500 font-medium tracking-tight">Configure your academic identity and security tokens.</p>
                </div>
                    ...
                    <div className="space-y-6">
                        <div className="relative group p-8 rounded-[2.5rem] bg-zinc-900/40 border border-white/5 backdrop-blur-xl flex flex-col items-center">
                            ...
                            <div className="text-center mt-6">
                                <h2 className="text-2xl font-black italic uppercase tracking-tight">{user?.username || 'Observer'}</h2>
                                <div className="flex items-center justify-center gap-2 mt-2">
                                    <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                                    <p className="text-[10px] text-zinc-500 font-black uppercase tracking-widest leading-none">Status: Active Node</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="md:col-span-2 space-y-8">
                        ...
                        <div className="relative p-8 rounded-[2.5rem] bg-zinc-900/40 border border-white/5 backdrop-blur-xl space-y-8">
                            ...
                            <div className="flex justify-between items-start">
                                <div className="space-y-1">
                                    <h3 className="text-xl font-black italic uppercase tracking-tight text-white">Security Uplink</h3>
                                    <p className="text-zinc-500 text-xs font-medium">Protect your workspace with advanced protocols.</p>
                                </div>
                            ...
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    <Label className="text-[10px] uppercase font-black tracking-widest text-zinc-500 ml-1">Registered Email</Label>
                                    <div className="relative">
                                        <Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-zinc-600" />
                                        <Input
                                            readOnly
                                            value={user?.email || 'unregistered@node.com'}
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest">
                                                Level: {user?.twoFactorEnabled ? 'ULTRA SECURE' : 'VULNERABLE'}
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div className="relative p-8 rounded-[2.5rem] bg-red-500/5 border border-red-500/20 backdrop-blur-xl">
                            ...
                            <div className="p-6 rounded-3xl bg-red-500/10 border border-red-500/20 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                                <div className="space-y-2">
                                    <h4 className="font-black italic uppercase tracking-wide text-white">Terminate Credentials</h4>
                                    <p className="text-[10px] text-red-400 font-medium leading-relaxed max-w-xs uppercase tracking-widest">
                                        This action will permanently delete your node from the academy infrastructure.
                                    </p>
                                </div>
                                <Button
                                    onClick={async () => {
                                        if (confirm("CRITICAL WARNING: Permanent Account Termination\n\nThis action cannot be undone. Type 'TERMINATE' to confirm.")) {
                                            ...
                                            if (promptCheck === 'TERMINATE') {
                                                try {
                                                    ...
                                                    toast.error("Critical failure during terminal sequence.");
                                                }
                                            }
                                        }
                                    }}
